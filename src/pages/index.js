...
const IndexPage = () => {
  ...
  return (
    <div className='pt-16'>
      ...
      >
        <title>ARCS '23 | By IEEECS-VIT</title>
        <link rel='icon' type='image/png' href={favicon} sizes='16x16' />
        <meta charset='UTF-8' />
        <meta property='og:title' content="ARCS '23" />
        ...
        <meta
          name='keywords'
          content="ARCS, ARCS '23, AARCS '23rcs, Arcs '23, AArcs '23RCS 2021, Arcs 2021, arcs '23, aarcs '23rcs, arcs 2021, IEEECS, IEEE CS, ieee cs, IEEE, IEEE Computer Society, IEEE Computer Society VIT, IEEE-CS VIT, VIT, vit, HackBattle, hackbattle , HackBattle '20, Hackbattle '23 , Hackbattle '23ieeecsvit, ieeecs"
        />
      </Helmet>
